...
import { fetchSettingsThunk } from '../../../../stores/thunks/settingsThunks.js';
			...
			<div className="container">
				<nav className="navbar navbar-expand-lg navbar-light py-3">
					...
					<Link to="/" className="navbar-brand">
						<span className="logo-text fw-bold fs-4">{settings?.brandName || 'Wedding Dream'}</span>
					</Link>
								...
								<div className="position-relative" ref={dropdownRef}>
									...
									{showDropdown && (
										<div className="dropdown-menu-custom show position-absolute end-0 mt-2 shadow-lg">
											...
											<button
												className="dropdown-item-custom px-3 py-2 d-flex align-items-center gap-2"
												onClick={() => handleMenuClick('/recently-viewed')}
											>
